...
DOX_chr_main <- sort(subset(gr_combined, seqnames == "8"))
...
mapped_7mer <- readRDS("input_data/mapped_7mers/mapped_7mer_chr8.rds")
mapped_7mer_df <- as.data.frame(mapped_7mer)

Chr_simplePeaks <- readRDS("input_data/simple_peaks_data/simple_peaks_chr8.rds")
Chr_simplePeaks_df <- as.data.frame(Chr_simplePeaks)

# read it in or make it with the function collapse_proximity 
collapsed_df <- readRDS("input_data/collapsed_df_chr8.rds")
...
p.txmodels <- plotTXmodelOverview(STMN2.txmodels)
